...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tagpad = __webpack_require__(168);

	ReactDOM.render(React.createElement(Tagpad, { page: 'browse' }), document.getElementById('react-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Browse = __webpack_require__(178);

	__webpack_require__(181);

	module.exports = function (props) {
	  var views = {
	    'add': React.createElement(Add, null),
	    'browse': React.createElement(Browse, null)
	  };
	  return React.createElement(
	    'div',
	    null,
	    React.createElement(Menu, { page: '{props.page}' }),
	    views[props.page]
	  );
	};
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('img', { className: 'logo', src: __webpack_require__(174) }),
	        'tagpad'
	      ),
	      React.createElement(
	        'a',
	        { href: '#', className: "item " + (props.page === 'browse' ? 'active' : '') },
	        'browse'
	      ),
	      React.createElement(
	        'a',
	        { href: '#', className: "item " + (props.page === 'add' ? 'active' : '') },
	        'add'
	      )
	    )
	  );
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { placeholder: 'title', type: 'text' })
	      ),
	      React.createElement(
	        'div',
	        { className: 'field' },
	        ...
	        React.createElement('textarea', { placeholder: 'content' })
	      ),
	      React.createElement(
	        'div',
	        { className: 'field' },
	        ...
	        React.createElement('input', { placeholder: 'tags', type: 'text' })
	      ),
	      React.createElement(
	        'button',
	        { className: 'savebutton ui right floated primary button' },
	        'save'
	      ),
	      React.createElement(
	        'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var items = [{ id: 1, type: 'note', 'title': 'thoughts on life',
	  'description': 'What is the meaning of it all?', tags: [] }, { id: 2, type: 'bookmark', 'title': 'google',
	  'description': 'this is a link to the popular search engine', tags: [] }, { id: 3, type: 'note', 'title': 'Ideas about space',
	  'description': 'How big is space really?', tags: [] }, { id: 4, type: 'location', 'title': "Enid's",
	...
	module.exports = function Browse(props) {
	  return React.createElement(
	    ...
	    React.createElement(ItemList, { items: props.items })
	  );
	};
