...
/***/ function(module, exports, __webpack_require__) {
	...
	var Browse = __webpack_require__(242);
	...
	function App(props) {
	  return React.createElement(
	    'div',
	    null,
	    React.createElement(Menu, { page: props.location.pathname.replace('/', '') }),
	    props.children
	  );
	}
	...
	function render() {
	  ...
	  var createElement = function (Component, props) {
	    return React.createElement(Component, _extends({ state: state }, props));
	  };

	  ReactDOM.render(React.createElement(
	    Router,
	    { history: hashHistory, createElement: createElement },
	    React.createElement(
	      Route,
	      { path: '/', component: App },
	      React.createElement(IndexRoute, { component: Browse }),
	...
	// set initial state.
	model.setState(__webpack_require__(247).state);
	...
	module.exports = function (props) {
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        Link,
	        { to: '/browse', className: 'header item' },
	        React.createElement('img', { className: 'logo', src: __webpack_require__(234) }),
	        'tagpad'
	      ),
	      React.createElement(
	        Link,
	        { to: '/browse', className: "item " + (props.page === 'browse' ? 'active' : '') },
	        'browse'
	      ),
	      React.createElement(
	        Link,
	        { to: '/add', className: "item " + (props.page === 'add' ? 'active' : '') },
	        'add'
	      )
	    )
	  );
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ui.menu .item img.logo {\n  margin-right: 1.5em;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "2aa9505fb394d3af3f6ee03ca72524fc.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function Add(props) {
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      'form',
	      { className: 'ui form', onSubmit: actions.submitNewItem },
	      React.createElement(
	        'div',
	        { className: 'field' },
	        React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { type: 'submit', className: 'savebutton ui right floated primary button' },
	        'save'
	      ),
	      React.createElement(
	        'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.submitNewItem = function () {
	  ...
	  var item = Object.assign({}, state.newItem, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".savebutton {\n  margin-left:0.8em !important;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ItemTags(props) {
	  return React.createElement(
	    'div',
	    { className: 'right ui labels' },
	    props.tags.map(function (tagName, index) {
	      return React.createElement(Tag, { key: index, name: tagName });
	    })
	  );
	}
	...
	function Item(props) {
	  ...
	  return React.createElement(
	    'div',
	    { className: 'item' },
	    React.createElement('i', { className: typeToClass[props.item.type] }),
	    React.createElement(
	      'div',
	      { className: 'content' },
	      React.createElement(
	      ...
	      React.createElement(ItemTags, { tags: props.item.tags })
	    )
	  );
	}
	...
	module.exports = function Browse(props) {
	  return React.createElement(
	    ...
	    React.createElement(ItemList, { items: props.state.items })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./browse.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./browse.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./tagpad.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./tagpad.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	exports.state = {
	  "items": [{ "id": 1, "type": "note", "title": "thoughts on life", "description": "What is the meaning of it all?", "tags": [] }, { "id": 2, "type": "bookmark", "title": "google", "description": "this is a link to the popular search engine", "tags": [] }, { "id": 3, "type": "note", "title": "Ideas about space", "description": "How big is space really?", "tags": [] }, { "id": 4, "type": "location", "title": "Enid's", "description": "At night a bar, during the day a delicious brunch spot.", "tags": ["Fun"] }],
	  "newItem": {
